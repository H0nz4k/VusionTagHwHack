...
def cmd_show(args) -> int:
    """WRITE variant 1/2/3 to NTAG user page 0x30, hold RF briefly, then off."""
    from elatec_uid_tool.protocol import ElatecError, SimpleProtocolClient
    from elatec_uid_tool.ntag import NtagI2CPlus
...
def main(argv=None) -> int:
    ...
    p_show.add_argument("variant", type=int, choices=(1, 2, 3))
    p_show.add_argument("--wait", type=float, default=20.0)
