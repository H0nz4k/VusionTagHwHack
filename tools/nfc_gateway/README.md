...
`show_app.py` / `/home/hw/bin/ov26-nfc-show.sh` — menu grafik 1/2/3 na firmware **v0.10e**. Flash na nový DEV tag: [`firmware/releases/README.md`](../../firmware/releases/README.md).
