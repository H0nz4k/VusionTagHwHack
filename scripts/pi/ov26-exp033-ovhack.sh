...
b = Path("/tmp/ov26_exp033_por.bin").read_bytes()
t = b.decode("ascii", "replace")
print(t[:4000])
print("---TAIL---")
print(t[-800:])
print("BYTES", len(b), "K", t.count("EXP-033"), "DONE", t.count("DONE"))
print("HB", t.count("HB "), "BUSY0", t.count("BUSY=0"), "BUSY1", t.count("BUSY=1"))
ok = t.count("EXP-033")==1 and t.count("DONE")==1 and "REF=01" in t and "N10=15F8" in t and "N13=15F8" in t
