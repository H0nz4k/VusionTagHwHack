#!/usr/bin/env bash
# EXP-024 A/B: reflash known-good v0.4b after v0.4c UART FAIL. Isolated.
set -euo pipefail
...
IDENT=/tmp/ov26_exp024_ab_ident.txt
FLASHLOG=/tmp/ov26_exp024_ab_flash.txt
POR=/tmp/ov26_exp024_ab_v04b.bin
...
b = Path("/tmp/ov26_exp024_ab_v04b.bin").read_bytes()
t = b.decode("ascii", "replace")
print(t[:1500])
print("BYTES", len(b), "K", t.count("EXP-023"), "hex", b[:24].hex())
