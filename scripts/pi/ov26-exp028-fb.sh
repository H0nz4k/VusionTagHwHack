...
b = Path("/tmp/ov26_exp028_por.bin").read_bytes()
t = b.decode("ascii", "replace")
print(t[:2800])
print("BYTES", len(b), "K", t.count("EXP-028"), "DONE", t.count("DONE"))
ok = t.count("EXP-028")==1 and t.count("DONE")==1 and "N10=15F8" in t and "N13=15F8" in t
