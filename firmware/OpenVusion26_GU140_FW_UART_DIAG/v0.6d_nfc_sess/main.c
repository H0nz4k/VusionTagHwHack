...
/*
 * EXP-043 / v0.6d — NFC-B read-only I2C session block 0xFE (8 bytes).
 * No P1_0. No EEPROM/config write. P0_2 untouched.
 * Flattened: main.c + clock + uart. --nooverlay.
 */
...
void main(void)
{
    ...
    uart_crlf();
    uart_puts("OpenVusion GU140 EXP-043 v0.6d NFC-B SESS");
    uart_crlf();
