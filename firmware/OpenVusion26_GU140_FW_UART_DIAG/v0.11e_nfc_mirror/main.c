...
/*
 * EXP-061 / v0.11e — I2C poll SRAM 0xF8 only. No session 0xFE write.
 * Host SRAM_MIRROR via E8 then WRITE 0x40. MCU polls I2C 0xF8.
...
void main(void)
{
    ...
    uart_crlf();
    uart_puts("OpenVusion GU140 EXP-061 v0.11e NFC-D MIRROR");
    uart_crlf();
