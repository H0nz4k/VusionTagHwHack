...
case "$TARGET" in
  v0.3a_uart_baseline|v0.3b_hsrc_13mhz|v0.3c_busy_passive|v0.3d_power_only|v0.3e_reset_probe|v0.3f_led_p2|v0.3g_led_slow|v0.3h_led_named|v0.3i_led_boost_sink|v0.3j_led_onoff|v0.3k_led_regdump|v0.4a_busy_passive|v0.4b_pwr_only|v0.4c_reset_hlh|v0.4d_spi_idle|v0.4e_cmd00|v0.4f_min_init|v0.4g_fb_load|v0.4h_refresh|v0.4i_stripes|v0.4j_bwr_cal|v0.4k_bwr_19|v0.4l_ovhack) ;;
...
if [[ "$TARGET" == v0.4c_reset_hlh || "$TARGET" == v0.4d_spi_idle || "$TARGET" == v0.4e_cmd00 || "$TARGET" == v0.4f_min_init || "$TARGET" == v0.4g_fb_load || "$TARGET" == v0.4h_refresh || "$TARGET" == v0.4i_stripes || "$TARGET" == v0.4j_bwr_cal || "$TARGET" == v0.4k_bwr_19 || "$TARGET" == v0.4l_ovhack ]]; then
    CFLAGS+=(--nooverlay)
fi
