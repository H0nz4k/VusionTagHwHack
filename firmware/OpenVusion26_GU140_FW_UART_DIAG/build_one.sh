...
if [[ "$TARGET" == v0.4c_reset_hlh || "$TARGET" == v0.4d_spi_idle || "$TARGET" == v0.4e_cmd00 || "$TARGET" == v0.4f_min_init || "$TARGET" == v0.4g_fb_load || "$TARGET" == v0.4h_refresh || "$TARGET" == v0.4i_stripes || "$TARGET" == v0.4j_bwr_cal || "$TARGET" == v0.4k_bwr_19 || "$TARGET" == v0.4l_ovhack || "$TARGET" == v0.5a_rf_dump || "$TARGET" == v0.5b_rf_idle || "$TARGET" == v0.5c_rf_rxrssi || "$TARGET" == v0.5d_rf_txping || "$TARGET" == v0.6a_nfc_ack || "$TARGET" == v0.6b_nfc_ack0 || "$TARGET" == v0.6c_nfc_uart || "$TARGET" == v0.6d_nfc_sess || "$TARGET" == v0.6e_nfc_sess2 || "$TARGET" == v0.6f_nfc_eep || "$TARGET" == v0.7a_nfc_fd_led || "$TARGET" == v0.7b_nfc_fd_1hz || "$TARGET" == v0.8a_nfc_refresh || "$TARGET" == v0.9a_nfc_show1 || "$TARGET" == v0.9b_nfc_show2 || "$TARGET" == v0.9c_nfc_show3 || "$TARGET" == v0.10a_nfc_showcmd || "$TARGET" == v0.10b_nfc_unlock || "$TARGET" == v0.10c_nfc_i2c_after_rf || "$TARGET" == v0.10d_nfc_show4 || "$TARGET" == v0.10e_nfc_show3 || "$TARGET" == v0.11a_nfc_sram || "$TARGET" == v0.11b_nfc_pthru || "$TARGET" == v0.11c_nfc_nc19 || "$TARGET" == v0.11d_nfc_poll ]]; then
    CFLAGS+=(--nooverlay)
fi
