...
/*
 * EXP-060 / v0.11d — I2C poll SRAM 0xF8 only. No session 0xFE write.
 * Host may set PTHRU via RF page 0xEC then WRITE F0. MCU just reads.
...
void main(void)
{
    ...
    uart_crlf();
    uart_puts("OpenVusion GU140 EXP-060 v0.11d NFC-D POLL");
    uart_crlf();
