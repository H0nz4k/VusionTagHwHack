...
/*
 * EXP-044 / v0.6e — NFC-B retry: STOP then START before 0xAB (not Sr).
 * One change vs v0.6d. Read-only. No P1_0. No EEPROM write.
 */
...
void main(void)
{
    ...
    uart_crlf();
    uart_puts("OpenVusion GU140 EXP-044 v0.6e NFC-B STOP");
    uart_crlf();
