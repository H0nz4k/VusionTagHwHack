...
#include "clock.h"
#include "uart1.h"
#include "img_ovhack.h"

/*
 * EXP-033 / v0.4l — OpenVusionHack content. Same init/SPI/DCDC/0x12 as v0.4k.
 * Planes generated offline (scripts/gen_ovhack_bwr.py):
 *   OpenVusion BLACK (p10=1 p13=0)
 *   Hack       RED   (p10=0 p13=1)
 *   background WHITE (p10=0 p13=0)
 * Native 152x296, 19 B/row, 5624 B/plane.
 */
...
void main(void)
{
    ...
    uart_crlf();
    uart_puts("OpenVusion GU140 EXP-033 v0.4l OVH");
    uart_crlf();
